...
class CrossValidator_Multitask:
    ...
    def start_cross_validation(self):
        ...
        for fold in self.args.validation_folds:
            ...
            # Paths
            self.model_name_folder = 'CV_{}_MUL_{}_{}_{}/'.format( self.cfg.dataset_path_crossValidation_severity.split("_")[1].replace("folds","F"), self.args.segmentation_network, self.args.num_epochs * self.args.sample_per_epoch, str(self.args.date.strftime( '%m%d_%H' )))
